...
DAN.profile['df_list']=['rain','temperature','wet','wind_direction','wind_power','RainMeter-O','Temperature-O','Humidity-O','WindDirection-O','WindSpeed-O']
...
while True:
    try:
        ...
        #==================================
        time.sleep(1)
        data1 = DAN.pull('RainMeter-O')
        time.sleep(0.5)
        data2 = DAN.pull('Temperature-O')
        time.sleep(0.5)
        data3 = DAN.pull('Humidity-O')
        time.sleep(0.5)
        data4 = DAN.pull('WindDirection-O')
        time.sleep(0.5)
        data5 = DAN.pull('WindSpeed-O')
        time.sleep(10)
        """
